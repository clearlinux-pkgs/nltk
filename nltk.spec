...
Source0  : https://files.pythonhosted.org/packages/31/78/00a70e1b1c1a275329aff7a72e83572f967372c921e2c1db5e9af7a4988f/nltk-3.6.1.zip
...
%prep
%setup -q -n nltk-3.6.1
cd %{_builddir}/nltk-3.6.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1617894870
...
cp %{_builddir}/nltk-3.6.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/nltk/2b8b815229aa8a61e483fb4ba0588b8b6c491890
